...
namespace TheLogicStudio\GrailPay;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.grailpay.com';
    ...
    {
        $report  = 'PHP SDK (TheLogicStudio\GrailPay) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2025.11.10.1' . PHP_EOL;
