...
/**
 * V1DeRegisterWebhookRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\GrailPay
 * @author   OpenAPI Generator team
 ...
 */
class V1DeRegisterWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V1DeRegisterWebhookRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('event_names', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['event_names'] === null) {
            $invalidProperties[] = "'event_names' can't be null";
        }
     ...
     * Sets event_names
     *
     * @param string[] $event_names event_names
     *
     * @return self
     */
    public function setEventNames($event_names)
    {
        if (is_null($event_names)) {
            throw new \InvalidArgumentException('non-nullable event_names cannot be null');
        }
