<?php
/**
 * V2OnboardBusinessResponseDataBankAccountRisk
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * V2OnboardBusinessResponseDataBankAccountRisk Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\GrailPay
 * @author   OpenAPI Generator team
 ...
 */
class V2OnboardBusinessResponseDataBankAccountRisk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V2OnboardBusinessResponse_data_bank_account_risk';
