...
/**
 * V3BankAccountObject Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\GrailPay
 * @author   OpenAPI Generator team
 ...
 */
class V3BankAccountObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V3BankAccountObject';
    ...
    protected static $setters = [
        'plaid_account_id' => 'setPlaidAccountId',
    ...
    protected static $getters = [
        'plaid_account_id' => 'getPlaidAccountId',
    ...
    {
        $this->setIfExists('plaid_account_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets plaid_account_id
     *
     * @return string|null
     */
    public function getPlaidAccountId()
    {
        return $this->container['plaid_account_id'];
    }

    /**
     * Sets plaid_account_id
     *
     * @param string|null $plaid_account_id plaid_account_id
     *
     * @return self
     */
    public function setPlaidAccountId($plaid_account_id)
    {
        if (is_null($plaid_account_id)) {
            array_push($this->openAPINullablesSetToNull, 'plaid_account_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('plaid_account_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['plaid_account_id'] = $plaid_account_id;
     ...
     *
     * @param string|null $plaid_access_token plaid_access_token
     *
     * @return self
     */
    public function setPlaidAccessToken($plaid_access_token)
    {
        if (is_null($plaid_access_token)) {
            array_push($this->openAPINullablesSetToNull, 'plaid_access_token');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('plaid_access_token', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
