...
/**
 * V2TransactionResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\GrailPay
 * @author   OpenAPI Generator team
 ...
 */
class V2TransactionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V2TransactionResponse';
    ...
    */
     ...
     *
     * @param string|null $payout_ach_return_code payout_ach_return_code
     *
     * @return self
     */
     ...
     *
     * @param string|null $payout_failure_reason payout_failure_reason
     *
     * @return self
     */
